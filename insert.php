...
$sql="INSERT INTO seed(fname,lname,phone,product,address,quantity) VALUES ('$fname','$lname','$phone','$product','$address','$quantity')";
...
<body>
    <p style="color:green; font: size:20px;"> your order is successfully done thank you  <br> for more go to home page</p>
